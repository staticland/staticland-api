...
server {
  ...
  ssl on;
  ssl_certificate /etc/letsencrypt/live/${opts.domain}/fullchain.pem;
  ssl_certificate_key /etc/letsencrypt/live/${opts.domain}/privkey.pem;
  ssl_trusted_certificate /etc/letsencrypt/live/${opts.domain}/fullchain.pem;
